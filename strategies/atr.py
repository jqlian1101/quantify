...
def GetStockDataApi(stockName=None, startTime=None, endTime=None, N1=15, N2=5, n_loss=0.8, n_win=2):
    """
    ATR值作为止盈止损的基准值，
    ...
    history_data = query_history.QueryHistory('sh.%s'%stockName, (startTime, endTime))
    stockdata = history_data.query_from_bs()
    ...
    stockdata['atr14'] = talib.ATR(stockdata.high.values, stockdata.low.values, stockdata.close.values, timeperiod=14)
...
if '__main__' == __name__:
    ...
    GetStockDataApi('600000', '2019-01-01', '2020-01-01')
