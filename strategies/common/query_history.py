...
class QueryHistory:
    ...
    def query_from_local(self):
        ...
        history_dir = os.path.join(work_dir, 'files/history',
                                   self.code.split('.')[1] + '.csv')
        ...
        return df[[
            'code', 'open', 'high', 'low', 'close', 'preclose', 'chg',
            'pctChg', 'turn', 'volume', 'amount', 'tcap', 'mcap'
        ]]
